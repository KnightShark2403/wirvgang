    ...
    return (
      <Card className="overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors duration-300">
        ...
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-white">Rishit Patel</CardTitle>
          <CardDescription className="text-blue-300">Frontend Developer</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-white/80">Frontend specialist with expertise in React and Next.js. Passionate about creating beautiful user interfaces and seamless experiences.</p>
        ...
        <CardFooter className="border-t border-white/10 flex justify-between">
          ...
          <button className="px-3 py-1 text-sm rounded-full bg-blue-500 hover:bg-blue-600 text-white transition-colors">Contact</button>
        </CardFooter>
      </Card>
    );
  };
  
  export default RishitCard;