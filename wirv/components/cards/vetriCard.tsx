  ...
  return (
    <Card className="overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors duration-300">
      <div className="h-48 bg-gradient-to-r from-blue-500 to-cyan-400 relative overflow-hidden">
        {/* Image now fills the entire blue area */}
        <Image 
          src="/beyblade-burst-free-de-la-hoya-b1yv0zbk3ts7nea0.jpg" 
          alt="Profile" 
          layout="fill" 
          objectFit="cover" 
        ...
        {/* Optional overlay to maintain some of the gradient effect */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/50 to-cyan-400/50" />
      </div>
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl font-bold text-white">GS Vetri</CardTitle>
        <CardDescription className="text-blue-300">LLM Dev</CardDescription>
      </CardHeader>
      <CardContent>
        <p className="text-white/80">Screw This!</p>
        <div className="mt-4 flex flex-wrap gap-2">
          <span className="px-2 py-1 bg-blue-500/20 text-blue-200 rounded-full text-xs">SQL server management</span>
          <span className="px-2 py-1 bg-blue-500/20 text-blue-200 rounded-full text-xs">Model Tuning</span>
          <span className="px-2 py-1 bg-blue-500/20 text-blue-200 rounded-full text-xs">LLM</span>
